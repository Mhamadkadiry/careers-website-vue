<template>
        <li class="mb-7">
                <router-link :to="jobUrl" class="mx-auto block rounded border border-solid border-brand-gray-2 bg-white hover:shadow-gray">
                    ...
                    <div class="px-8 py-4">
                        ...
                        <div class="mt-2 text-center">
                            <router-link :to="jobUrl" class="text-brand-blue-1">
                                Expand
                            </router-link>
                        </div>
                    </div>
